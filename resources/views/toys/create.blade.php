...
<body>
    ...
    @yield('content')
    <form method="POST" action="{{ route('toy.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row" style="min-height: 100vh">
            <div class="col-4 d-flex justify-content-center align-items-center flex-column border-1 border-end border-dark">
                <div class="mb-3">
                    <label for="formFile" class="form-label">Upload your toy image!</label>
            ...
            <div class="col-8 d-flex justify-content-center align-items-start flex-column ps-5">
                ...
                <div class="w-75">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" placeholder="Toy Name" name="name">
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="floatingInput" placeholder="Stock" name="stock">
